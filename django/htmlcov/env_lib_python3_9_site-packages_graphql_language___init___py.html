...
<head>
    ...
    <title>Coverage for env/lib/python3.9/site-packages/graphql/language/__init__.py: 100%</title>
...
<div id="header">
    <div class="content">
        <h1>Coverage for <b>env/lib/python3.9/site-packages/graphql/language/__init__.py</b> :
